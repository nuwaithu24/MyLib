...
//! \~japanese 統計情報取得コールバックシグネチャ
//!
//!  statsは`RTCStats Dictionary`に準拠したオブジェクトの配列(NSArray)です。
//!  https://www.w3.org/TR/webrtc/#rtcstats-dictionary
//!
//!  こちらに含まれる`type`キーに関しては、`RTCStatsType enum`を参照してください。
//!  https://www.w3.org/TR/webrtc-stats/#rtcstatstype-str*
//!
//!  取得できる統計情報は`Stats Dictionary`を参照してください。
//!  https://www.w3.org/TR/webrtc-stats/#stats-dictionaries
//!
//!  \~english Getting statistics Callback signature.
//!
//!  The stats argument is an array(NSArray) of objects based on `RTCStats Dictionary`.
//!  https://www.w3.org/TR/webrtc/#rtcstats-dictionary
//!
//!  See document `RTCStatsType enum` about `type` key included in the array.
//!  https://www.w3.org/TR/webrtc-stats/#rtcstatstype-str*
//!
//!  See also `Stats Dictionary` for the statistical data that can be obtained.
//!  https://www.w3.org/TR/webrtc-stats/#stats-dictionaries
//!
//! \~
...
//! \~japanese コネクションの統計情報を取得します
//! \~english Get statistics of the connection
//! \~
//!
//! @param callback
//! \~japanese 統計情報取得後のBlock を設定します。
